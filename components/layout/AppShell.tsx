...
interface AppShellProps {
    ...
    /** Show 1 Login → 2 Courses → 3 Run. Omit to hide (e.g. privacy). */
    activeStep?: AppStep;
    showSteps?: boolean;
}
...
export const AppShell = ({
    ...
    return (
        <div className="min-h-screen flex flex-col bg-background text-body font-sans selection:bg-mint/40">
            ...
            {showSteps && activeStep != null && <StepIndicator active={activeStep} />}
            ...
            <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
                ...
                <div
                    className="absolute bottom-32 -right-20 w-96 h-96 bg-lilac/10 rounded-full blur-[100px] hero-glow"
